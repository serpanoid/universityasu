        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_AspNetUsers_HeadOfDepartmentId1",
                        column: x => x.HeadOfDepartmentId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Disciplines_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradingPolicy = table.Column<string>(type: "text", nullable: true),
                    Textbooks = table.Column<List<string>>(type: "text[]", nullable: true),
                    CourseSchedule = table.Column<List<string>>(type: "text[]", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Disciplines_ApplicationUserId",
                table: "Disciplines",
